...
from Todo.api.viewsets import TareaViewSet, CategoriaViewSet
from rest_framework.urlpatterns import format_suffix_patterns
from Todo.api.views import categoria_list, tarea_list
from Todo.api.views import categoria_detail, tarea_detail
